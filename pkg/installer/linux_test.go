...
// TestLinuxInstaller_Install 测试Linux平台安装器的基本方法
...
// TestLinuxInstaller_Install_WithSudo 测试使用sudo安装的情况
func TestLinuxInstaller_Install_WithSudo(t *testing.T) {
	// 准备模拟环境
	mockEnv := setupLinuxMockEnv()
	...
	// 创建安装器
	_ = NewLinuxInstaller(config)

	// 由于我们没有实际的依赖注入机制，所以这里只是演示测试方法

	t.Log("Linux安装器使用sudo安装测试 - 仅做方法示例，未实际测试")
}

// TestLinuxInstaller_Install_WithoutSudo 测试不使用sudo安装的情况
func TestLinuxInstaller_Install_WithoutSudo(t *testing.T) {
	// 准备模拟环境
	mockEnv := setupLinuxMockEnv()
	...
	t.Log("Linux安装器不使用sudo安装测试 - 仅做方法示例，未实际测试")
}

// TestLinuxInstaller_Install_InsufficientRights 测试权限不足且不使用sudo的情况
func TestLinuxInstaller_Install_InsufficientRights(t *testing.T) {
	// 准备模拟环境
	mockEnv := setupLinuxMockEnv()
	...
	t.Log("Linux安装器权限不足且不使用sudo测试 - 仅做方法示例，未实际测试")
}
...
func TestLinuxInstall(t *testing.T) {
	// TODO: 创建真实的测试用例，可能需要使用mock
	t.Skip("Linux安装测试需要在Linux环境中运行")
}
